 ...
 */
interface LocalAsyncCache<K extends Object, V extends Object> extends AsyncCache<K, V> {
  ...
  default void put(K key, CompletableFuture<? extends V> valueFuture) {
    ...
    handleCompletion(key, castedFuture, startTime, /* recordMiss */ false);
  }
  ...
  final class AsyncBulkCompleter<K extends Object, V extends Object>
  ...
  /* --------------- Synchronous view --------------- */
  final class CacheView<K extends Object, V extends Object> extends AbstractCacheView<K, V> {
    private static final long serialVersionUID = 1L;
  ...
  abstract class AbstractCacheView<K extends Object, V extends Object>
  ...
  final class AsMapView<K extends Object, V extends Object>
